...
public static class ProtoCopy
{
	public const string PathEditorProto = "Assets/Scripts/Game/Editor/Proto";
	public const string PathClientProto = "Assets/Scripts/Game/Client/Proto";
	public const string PathServerProto = "Assets/Scripts/Game/Server/Proto";

	[MenuItem("Proto/CopyProto")]
